#ifndef _ROS_trimode_msgs_Feedback_h
#define _ROS_trimode_msgs_Feedback_h
...
#include "trimode_msgs/DriveFeedback.h"

namespace trimode_msgs
{
  ...
  class Feedback : public ros::Msg
  {
    public:
      ...
      _header_type header;
      trimode_msgs::DriveFeedback drivers[2];
    ...
    const char * getType(){ return "trimode_msgs/Feedback"; };
