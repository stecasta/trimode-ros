#ifndef _ROS_trimode_control_BoolList_h
#define _ROS_trimode_control_BoolList_h
...
namespace trimode_control
{
  ...
  class BoolList : public ros::Msg
  {
    ...
    const char * getType(){ return "trimode_control/BoolList"; };
