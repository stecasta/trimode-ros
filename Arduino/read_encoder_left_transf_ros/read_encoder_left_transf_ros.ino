...
ros::Publisher pub("encoder_left_vel_transf", &wheel_pos);
ros::Publisher pub_home("home_left_position", &home_pos);
...
wheel_pos.data[0] = newposition1;
wheel_pos.data[1] = newposition0;
...
if (digitalRead(switchPin1)){
  home_pos.data[0] = digitalRead(switchPin1);
  encoder1Pos = 0;
}
else{
  home_pos.data[0] = 0;
